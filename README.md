...
5.  Čísla vypisujte v desítkovém zápisu s přesností na dvě desetinná místa. Pozor, některé nástroje (např. `awk`) mohou větší čísla vypisovat implicitně pomocí vědeckého zápisu.
